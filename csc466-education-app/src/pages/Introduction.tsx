  ...
  return (
    <>
      ...
      <article>
        ...
        <p>
          Before you hop on Zoom for 5+ hours, you probably have to pick out what
        ...
        <p>
          ...
          set of data. Our goal when choosing a feature is to minimize the overall
          entropy, which is equivalent to maximizing information gained with each
        ...
        <ol>
          ...
          <li>
            On cold days, we can see that energy level makes a much bigger impact
      ...
      <CTACard>
        <span>
          <h2>Practice time</h2>
          <p>
            If you're ready, see how to get hands on experience with some examples
          </p>
        </span>
        <Button
          component="a"
